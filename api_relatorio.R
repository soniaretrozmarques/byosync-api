# ================================================================
# 🌐 API ByoSync — Geração automática de relatórios
# ================================================================
# Este ficheiro cria um endpoint HTTP (POST /run_report)
# que o Google Apps Script pode chamar sempre que há uma nova submissão
# no Google Forms. O endpoint executa o teu script R principal
# (por exemplo, gerar_relatorio.R) com os dados do tester.
# ================================================================
...
# ⚠️ CORRIGIDO: usar barras duplas "\\" ou barras normais "/" em caminhos Windows
R_SCRIPT_PATH <- file.path(getwd(), "byosync_automacao.R")
LOG_DIR       <- "C:/Users/35191/Documents/ByoSync Health/FASE_3_VERSAO_BETA_DADOS_REAIS/logs"
...
# ================================================================
# Exemplo de chamada:
# POST http://127.0.0.1:8080/run_report
# {
#   "tester_id": "T01",
...
# ================================================================
# Corre isto no R para iniciar o servidor:
